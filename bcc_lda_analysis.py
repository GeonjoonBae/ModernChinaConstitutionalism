...
# 경로 설정
data_file = "bcc_corpus/bcc_corpusdata_constitution_1872-1945.csv"
output_dir = "bcc_corpus/results_lda"
stopwords_file = "rmrb_stopwords.txt"
...
for keyword in keywords:
    ...
    def run_lda(text_data, keyword, year=None):
        ...
        lda_model = models.LdaModel(corpus, num_topics=15, id2word=dictionary, passes=20, iterations=500, random_state=42)
